...
const cards = [
  {
    ...
    desc: "CGPA 8.9 — 2 semesters completed",
  },
  {
    icon: Award,
    title: "Certification",
    desc: "GUVI Full Stack Development",
  },
  {
    icon: Target,
    title: "Career Goal",
    desc: "Aspiring Software Engineer, Seeking Internship",
  },
];
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        <div className="space-y-4 text-muted-foreground leading-relaxed">
          <p>
            ...
            12th standard. Since then, I have been deeply curious about
            programming languages and modern frameworks.
          </p>
          <p>
            After completing my Full Stack Development certification from GUVI, I
            have been actively preparing myself to transition into the tech
            industry.
          </p>
          <p>
        ...
        <div className="grid gap-4">
          {cards.map((c) => (
            <div
              key={c.title}
              className="glass rounded-xl p-5 flex items-start gap-4 hover:border-primary/50 transition-all duration-300 hover:-translate-y-0.5"
            >
