...
const Contact = () => {
    ...
    return (<section id="contact" className="section-padding relative">
      <div className="container mx-auto px-4 md:px-8">
          ...
          <AnimatedSection delay={0.1}>
            ...
            { icon: MapPin, label: "Chennai, Tamil Nadu, India" },
        ].map((item) => (<div key={item.label} className="flex items-center gap-4">
              ...
              <div className="flex gap-3 pt-4">
                <a href="https://github.com/srinaveenrajr" target="_blank" rel="noopener noreferrer" className="p-3 rounded-lg bg-secondary hover:bg-primary hover:text-primary-foreground transition-all text-muted-foreground">
                  <Github size={20}/>
                </a>
                <a href="https://www.linkedin.com/in/sri-naveenraj-r/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-lg bg-secondary hover:bg-primary hover:text-primary-foreground transition-all text-muted-foreground">
                  <Linkedin size={20}/>
                </a>
              </div>
