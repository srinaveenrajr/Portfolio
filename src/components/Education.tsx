...
const timeline = [
  ...
  },
  {
    ...
    detail:
      "Completed Full Stack Development certification. Currently preparing DSA and applying for internships.",
    side: "right" as const,
  },
];
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        {timeline.map((item, i) => (
          <div
            key={i}
            className="glass rounded-2xl p-6 hover:border-primary/50 transition-all duration-300 hover:-translate-y-0.5"
          >
